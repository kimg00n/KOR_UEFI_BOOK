...
<figure><img src=".gitbook/assets/image (4).png" alt=""><figcaption><p>UEFITool의 실행화면</p></figcaption></figure>



&#x20;여태까지 Linux 환경에서 작업하였던 `OVMF.fd`를 가져와서 UEFITool을 통하여 UEFI Firmware 파일을 열어보자.

<figure><img src=".gitbook/assets/image (2).png" alt=""><figcaption><p>OVMF.fd in UEFITool</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (6).png" alt=""><figcaption><p>GUID 값 입력</p></figcaption></figure>

<figure><img src=".gitbook/assets/image (1).png" alt=""><figcaption><p>GUID를 인식하는 모습</p></figcaption></figure>
