...
<figure><img src=".gitbook/assets/image (2) (2).png" alt=""><figcaption><p>MemoryInfo.efi</p></figcaption></figure>

efi Shell에서 `memmap`명령어를 실행하여 결과가 맞는지 확인이 가능하다.

<figure><img src=".gitbook/assets/image (3) (2) (1).png" alt=""><figcaption><p>memmap result</p></figcaption></figure>
