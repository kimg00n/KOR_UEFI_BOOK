...
&#x20;이 출력을 구현하는 것에는 신경쓰지 말자. 이는 다른 translation level에서 발생하는 것이고, 이번 장에서는 UEFI Graphic(Native 또는 VNC)을 살펴보도록 하자.
...
&#x20;이는 자바스크립트와 관련된 장장이 아니지만, 스크립트에 대한 설명이 필요하다고 생각한다. 먼저 글꼴을 load하고 canvas와 스크립트 코드를 선언하는 HTML 부분이다.
