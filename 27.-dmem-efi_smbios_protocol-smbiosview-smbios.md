...
또한 코드 작성전 GetNext 호출에서 파라미터로 사용되는 EFI\_SMBIOS\_TABLE\_HEADER 구조의 정의를 살펴보겠다.\
[https://github.com/tianocore/edk2/blob/master/MdePkg/Include/Protocol/Smbios.h](https://github.com/tianocore/edk2/blob/master/MdePkg/Include/Protocol/Smbios.h)
...
따라서 EFI\_SMBIOS\_TABLE\_HEADER\* 및 string 숫자에서 실제 ASCII 문자열을 반환하는 간단한 함수를 작성하겠다.
...
위의 모든 것을 바탕으로 while문을 이용해서 실제적으로 parsing을 하는 코드를 작성할 수 있다.
...
이러한 SMBIOS 테이블에 있는 정보와 동일한 정보가 기본 BIOS 메뉴에 존재하는 것을 기억하고 있어야 한다.\
해당 SMBIOS ㄱ구ㄱ
