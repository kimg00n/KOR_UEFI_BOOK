...
<figure><img src=".gitbook/assets/image (3) (2) (1).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (20).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (6).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>

`text` 요소와 `subtitle` 요소의 차이점은 `text` 요소는 선택할 수 있다는 점이다.

TEXT1 title을 생성했던 방법과 똑같이 TEXT2 title을 생성한다.

<figure><img src=".gitbook/assets/image (3) (1).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (2) (6).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
