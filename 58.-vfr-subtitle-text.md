...
<figure><img src=".gitbook/assets/image.png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (18).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (1).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>

`text` 요소와 `subtitle` 요소의 차이점은 `text` 요소는 선택할 수 있다는 점이다.

TEXT1 title을 생성했던 방법과 똑같이 TEXT2 title을 생성한다.

<figure><img src=".gitbook/assets/image (12).png" alt=""><figcaption><p>HIIStaticForm.efi</p></figcaption></figure>
